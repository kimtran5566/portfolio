...
const SuccessfullyRegister = () => {
	const phoneNumber = useAppSelector((state) => state.user.userName);
				...
				<div className="w-[500px] box-border shadow-[0_3px_10px_0_rgba(0,0,0,.14)] rounded">
					...
					<div className="px-[80px] pb-[64px]">
						<p className="mt-[10px] mb-[30px] text-base text-center min-h-10 ">
							Bạn đã tạo thành công tài khoản EZ Shop với số
							<span className="text-[#ee4d2d] ml-2">{phoneNumber}</span>
						</p>
						<p className="mt-[10px] mb-[30px] text-base text-center min-h-10 ">
							Bạn sẽ được chuyển hướng đến EZ Shop trong {time} giây
						</p>
					</div>
				</div>
			</div>
